...
INSERT INTO EPISODE_WRITERS VALUES
(@Episode1, @Writer1),
(@Episode2, @Writer5),
(@Episode2, @Writer3),
(@Episode3, @Writer1),
...
INSERT INTO EPISODE_ROLES VALUES
(@Episode1, @JerrySeinfeldRole),
(@Episode1, @ElaineBenes),
(@Episode1, @GeorgeConstanza),
(@Episode1, @CosmoKramer),
(@Episode2, @JerrySeinfeldRole),
(@Episode2, @ElaineBenes),
(@Episode2, @GeorgeConstanza),
(@Episode2, @CosmoKramer),
(@Episode3, @JerrySeinfeldRole),
(@Episode3, @ElaineBenes),
(@Episode3, @GeorgeConstanza),
(@Episode3, @CosmoKramer),
(@Episode4, @JerrySeinfeldRole),
(@Episode4, @ElaineBenes),
(@Episode4, @GeorgeConstanza),
(@Episode4, @CosmoKramer),
(@Episode5, @JerrySeinfeldRole),
(@Episode5, @ElaineBenes),
(@Episode5, @GeorgeConstanza),
(@Episode5, @CosmoKramer),
(@Episode6, @JerrySeinfeldRole),
(@Episode6, @ElaineBenes),
(@Episode6, @GeorgeConstanza),
(@Episode6, @CosmoKramer),
(@Episode7, @JerrySeinfeldRole),
(@Episode7, @ElaineBenes),
(@Episode7, @GeorgeConstanza),
(@Episode7, @CosmoKramer),
(@Episode8, @JerrySeinfeldRole),
(@Episode8, @ElaineBenes),
(@Episode8, @GeorgeConstanza),
(@Episode8, @CosmoKramer),
(@Episode9, @FrasierCrane),
(@Episode9, @NilesCrane),
(@Episode10, @FrasierCrane),
(@Episode10, @NilesCrane),
(@Episode11, @FrasierCrane),
(@Episode11, @NilesCrane),
(@Episode12, @Penny),
(@Episode12, @SheldonCooper),
(@Episode13, @Penny),
(@Episode13, @SheldonCooper),
(@Episode14, @Penny),
(@Episode14, @SheldonCooper),
(@Episode15, @Penny),
(@Episode15, @SheldonCooper),
(@Episode16, @Penny),
(@Episode16, @SheldonCooper),
(@Episode17, @Penny),
(@Episode17, @SheldonCooper),
(@Episode18, @Penny),
(@Episode18, @SheldonCooper),
(@Episode19, @Penny),
(@Episode19, @SheldonCooper),
(@Episode20, @Penny),
(@Episode20, @SheldonCooper),
(@Episode21, @Penny),
(@Episode21, @SheldonCooper),
(@Episode22, @RachelGreen),
(@Episode22, @MonicaGeller),
(@Episode22, @PhoebeBuffay),
(@Episode23, @RachelGreen),
(@Episode23, @MonicaGeller),
(@Episode23, @PhoebeBuffay),
(@Episode24, @RachelGreen),
(@Episode24, @MonicaGeller),
(@Episode24, @PhoebeBuffay),
(@Episode25, @RachelGreen),
(@Episode25, @MonicaGeller),
(@Episode25, @PhoebeBuffay),
(@Episode26, @RachelGreen),
(@Episode26, @MonicaGeller),
(@Episode26, @PhoebeBuffay),
(@Episode27, @MichaelScott),
(@Episode27, @PamBeesly),
(@Episode27, @JimHalpert),
(@Episode28, @MichaelScott),
(@Episode28, @PamBeesly),
(@Episode28, @JimHalpert),
(@Episode29, @MichaelScott),
(@Episode29, @PamBeesly),
(@Episode29, @JimHalpert),
(@Episode30, @PhilipBanks),
(@Episode30, @WillSmithRole),
(@Episode31, @PhilipBanks),
(@Episode31, @WillSmithRole),
(@Episode32, @PhilipBanks),
(@Episode32, @WillSmithRole),
(@Episode33, @PhilipBanks),
(@Episode33, @WillSmithRole),
(@Episode34, @DorothyZbornak),
(@Episode34, @RoseNylund),
(@Episode34, @BlancheDevereaux),
(@Episode35, @DorothyZbornak),
(@Episode35, @RoseNylund),
(@Episode35, @BlancheDevereaux),
(@Episode36, @SamMalone),
(@Episode36, @DianeChambers),
(@Episode36, @NormPeterson),
(@Episode36, @WoodyBoyd),
(@Episode37, @SamMalone),
(@Episode37, @DianeChambers),
(@Episode37, @NormPeterson),
(@Episode37, @WoodyBoyd),
(@Episode38, @TonySoprano),
(@Episode38, @JenniferMelfi),
(@Episode39, @TonySoprano),
(@Episode39, @JenniferMelfi),
(@Episode40, @DorothyZbornak),
(@Episode41, @PamBeesly),
(@Episode42, @WillSmithRole),
(@Episode43, @WoodyBoyd),
(@Episode44, @NormPeterson),
(@Episode45, @JenniferMelfi),
(@Episode46, @RachelGreen),
(@Episode47, @PamBeesly),
(@Episode48, @RachelGreen),
(@Episode49, @JenniferMelfi),
(@Episode50, @SamMalone),
(@Episode51, @PamBeesly),
(@Episode52, @DorothyZbornak),
(@Episode53, @SamMalone);

INSERT INTO PRODUCTION_COMPANY_SHOWS VALUES
(@ProductionStudioTest1, @Seinfeld),
(@ProductionStudioTest2, @Seinfeld),
(@ProductionStudioTest3, @Frasier),
(@ProductionStudioTest4, @BigBangTheory),
(@ProductionStudioTest5, @BigBangTheory),
(@ProductionStudioTest1, @Friends),
(@ProductionStudioTest1, @Office),
(@ProductionStudioTest4, @Office),
(@ProductionStudioTest8, @FreshPrince),
(@ProductionStudioTest9, @GoldenGirls),
(@ProductionStudioTest10, @GoldenGirls),
(@ProductionStudioTest11, @GoldenGirls),
(@ProductionStudioTest12, @Cheers),
(@ProductionStudioTest8, @Cheers),
(@ProductionStudioTest3, @Sopranos),
(@ProductionStudioTest4, @ShowTest1),
(@ProductionStudioTest5, @ShowTest2),
(@ProductionStudioTest6, @ShowTest3),
(@ProductionStudioTest8, @ShowTest4),
(@ProductionStudioTest9, @ShowTest4),
(@ProductionStudioTest10, @ShowTest5),
(@ProductionStudioTest14, @ShowTest6),
(@ProductionStudioTest15, @ShowTest6),
(@ProductionStudioTest20, @ShowTest7),
(@ProductionStudioTest18, @ShowTest8),
(@ProductionStudioTest19, @ShowTest8),
(@ProductionStudioTest3, @ShowTest9),
(@ProductionStudioTest2, @ShowTest10),
(@ProductionStudioTest10, @ShowTest10),
(@ProductionStudioTest12, @ShowTest10),
(@ProductionStudioTest17, @ShowTest11),
(@ProductionStudioTest5, @ShowTest12),
(@ProductionStudioTest12, @ShowTest12);
